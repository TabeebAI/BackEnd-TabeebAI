...
urlpatterns = [
    ...
    path("TabebAI/password/reset/confirm/<uidb64>/<token>/", auth_views.PasswordResetConfirmView.as_view(),name="password_reset_confirm"),
    path('TabebAI/DR/login/',LoginDRViwe.as_view(),name='DR_login'),
    path("TabebaAI/CreateDoctor/",CreateDoctor.as_view())
]
